...
soc_model=`getprop ro.vendor.qti.soc_model`
if [ x"$soc_model" = x"SM7675" ]; then
	echo cliffs
	platform="cliffs"
fi

if [ x"$soc_model" = x"SM7635" -o x"$soc_model" = x"SM6650" ]; then
	echo volcano
	platform="volcano"
fi
...
if [ x"$platform" = x"blair" ]; then
        echo blair
        lit_cfrqs=(300000 576000 691200 940800 1113600 1324800 1516800 1651200 1708800 1804800)
        big_cfrqs=(691200 940800 1228800 1401600 1516800 1651200 1804800 1900800 2054400 2208000)
        policies=(0 6)
fi
...
if [ x"$platform" = x"cliffs" ]; then
	echo cliffs
	lit_cfrqs=(364800 441600 595200 787200 902400 1017600 1113600 1228800 1344000 1478400 1593600 1708800 1804800)
	big_cfrqs=(480000 633600 787200 940800 1056000 1190400 1286400 1401600 1497600 1593600 1708800 1824000 1920000 2073600 2188800 2361600 2515200)
	gold_cfrqs=(480000 633600 787200 960000 1094400 1209600 1324800 1459200 1651200 1766400 1900800 2150400 2304000 2457600 2668800 2803200)
	policies=(0 3 7)
fi

if [ x"$platform" = x"volcano" ]; then
	echo volcano
	lit_cfrqs=(441600 595200 787200 902400 1017600 1113600 1228800 1344000 1497600 1593600 1708800 1804800)
	big_cfrqs=(480000 633600 787200 940800 1056000 1190400 1286400 1401600 1497600 1612800 1708800 1824000 1920000 2016000 2073600 2208000 2400000)
	gold_cfrqs=(480000 633600 787200 960000 1094400 1209600 1324800 1459200 1651200 1766400 1900800 2208000 2304000 2496000)
	if [ x"$soc_model" = x"SM6650" ]; then
	  big_cfrqs=(480000 633600 787200 940800 1056000 1190400 1286400 1401600 1497600 1612800 1708800 1824000 1920000 2016000 2073600 2208000)
	  gold_cfrqs=(480000 633600 787200 960000 1094400 1209600 1324800 1459200 1651200 1766400 1900800 2208000 2304000)
	fi
	policies=(0 4 7)
fi
...
display_freq() {
  ...
  elif [ x"$platform" = x"cliffs" ]; then
    echo "policy3 cur_freq: " $(< /sys/devices/system/cpu/cpufreq/policy3/scaling_cur_freq)
  elif [ x"$platform" = x"volcano" ]; then
  ...
  elif [ x"$platform" = x"blair" ]; then
    echo "policy6 cur_freq: " $(< /sys/devices/system/cpu/cpufreq/policy6/scaling_cur_freq)
  else
    echo "policy4 cur_freq: " $(< /sys/devices/system/cpu/cpufreq/policy4/scaling_cur_freq)
  fi
